...
def main():
    logger.info(f"Part 1 of {name} is {separator_passport_part_1()}. Runtime {datetime.now()-run_time}")
    logger.info(f"Part 2 of {name} is {valid_passport_part_2()}. Runtime {datetime.now()-run_time} ")
